...
export const MOCK_ANIME_CATALOG: Anime[] = [
  {
    ...
    watchOrder: [
      { id: 'e1', type: ContentType.EPISODE, title: 'The Summoning', duration: '48m', orderIndex: 1, isReleased: true, thumbnail: 'https://picsum.photos/300/170?random=101', description: 'The masters begin their preparations.' },
      { id: 'e2', type: ContentType.EPISODE, title: 'False Start', duration: '24m', orderIndex: 2, isReleased: true, thumbnail: 'https://picsum.photos/300/170?random=102', description: 'The first battle commences at the docks.' },
      { id: 'e3', type: ContentType.EPISODE, title: 'Land of Fuyuki', duration: '24m', orderIndex: 3, isReleased: true, thumbnail: 'https://picsum.photos/300/170?random=103', description: 'Secrets of the city are revealed.' },
      { id: 'm1', type: ContentType.MOVIE, title: 'Fate/Chronicle: The Lost Butterfly', duration: '1h 58m', orderIndex: 4, isReleased: true, thumbnail: 'https://picsum.photos/300/170?random=104', description: 'A mandatory movie bridging the gap between seasons.' },
      { id: 'e4', type: ContentType.EPISODE, title: 'The Final Command', duration: '24m', orderIndex: 5, isReleased: true, thumbnail: 'https://picsum.photos/300/170?random=105', description: 'The war reaches its climax.' },
    ]
  },
  {
    id: '2',
    ...
    watchOrder: [
      { id: 'e1', type: ContentType.EPISODE, title: 'Let You Down', duration: '24m', orderIndex: 1, isReleased: true, thumbnail: 'https://picsum.photos/300/170?random=201', description: 'Life in Night City is tough.' },
      { id: 'e2', type: ContentType.EPISODE, title: 'Like A Boy', duration: '24m', orderIndex: 2, isReleased: true, thumbnail: 'https://picsum.photos/300/170?random=202', description: 'He gets his first upgrade.' },
    ]
  },
  {
    id: '3',
    ...
    watchOrder: [
      { id: 'e1', type: ContentType.EPISODE, title: 'To You, 2000 Years Later', duration: '24m', orderIndex: 1, isReleased: true, thumbnail: 'https://picsum.photos/300/170?random=301', description: 'The wall is breached.' },
      { id: 'ova1', type: ContentType.OVA, title: 'Ilse\'s Notebook', duration: '28m', orderIndex: 1.5, isReleased: true, thumbnail: 'https://picsum.photos/300/170?random=302', description: 'A scout finds a strange journal.' },
      { id: 'e2', type: ContentType.EPISODE, title: 'That Day', duration: '24m', orderIndex: 2, isReleased: true, thumbnail: 'https://picsum.photos/300/170?random=303', description: 'Training begins.' },
    ]
  },
  {
    id: '4',
