...
const SidebarItem = ({ icon, label, active, onClick }: any) => (
  <button 
    onClick={onClick}
    className={`w-full flex items-center gap-3 px-5 py-4 rounded-xl text-sm font-mono tracking-wide transition-all duration-300 group relative overflow-hidden ${
      active 
  ...
  const handleGoogleLogin = () => {
    ...
    setTimeout(() => {
      setUser({
        id: 'google-user-1',
        name: 'Otaku Master',
        email: 'otaku.master@gmail.com',
        avatar: 'https://lh3.googleusercontent.com/a/ACg8ocIq8dD8j5d7s8s9s0s=s96-c',
        isGuest: false,
        watchlist: ['1', '3'],
        history: []
      });
